...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        body {
            background: radial-gradient(circle at 20% 20%, rgba(168, 85, 247, 0.08), transparent 25%), radial-gradient(circle at 80% 0%, rgba(236, 72, 153, 0.08), transparent 25%), #0b0c10;
            margin: 0;
            padding: 0;
        }
        ...
        .glass>div[style*="display:grid"] {
            gap: 16px !important;
        }

        .glass>div[style*="display:grid"]>div {
            min-width: 0;
            overflow: visible;
            margin-bottom: 0;
        }
