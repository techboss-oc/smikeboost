...
function admin_provider_request(array $provider, string $action, array $payload = [])
{
    ...
    return ['error' => 'Invalid response format'];
        ...
        return false;
         ...
         admin_normalize_provi
    
        isset($resp['data']) && is
        $resp = $resp['data'];
        seif (isset($resp['services']) && is_array($resp['services
